...
class TestFrameResource final : public deepstream_runtime::FrameResource {
 public:
...
deepstream_runtime::PlateWorkItem job(uint64_t track_id) {
...
int main() {
  deepstream_runtime::PlateJobQueue queue(2U);
  ...
  try {
    deepstream_runtime::PlateJobQueue invalid(0U);
  ...
  deepstream_runtime::PlateJobQueue lease_queue(1U);
  ...
  deepstream_runtime::EngineBatchProfiles profiles;
  profiles.plate = {1U, 4U, 4U, true};
  deepstream_runtime::ProcessingCoordinator coordinator(config, profiles);
  ...
  deepstream_runtime::ProcessingCoordinator draining(small_queue_config, profiles);
  std::atomic<size_t> handled{0U};
  deepstream_runtime::PlateWorker worker(
      &draining, [&handled](const std::vector<deepstream_runtime::PlateWorkItem>& jobs) {
  ...
  deepstream_runtime::ProcessingCoordinator failing(config, profiles);
  deepstream_runtime::PlateWorker failing_worker(
      &failing, [](const std::vector<deepstream_runtime::PlateWorkItem>&) -> size_t {
